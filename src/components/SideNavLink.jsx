...
const SideNavLink = ({ data, active, id, onClick }) => {
  return (
    <button
      className={`w-full h-full md:h-auto block uppercase text-[3vw] md:text-base xl:text-[1.25vw] hover:font-medium hover:text-[--white] pointer-events-auto text-left  text-nowrap md:text-wrap`}
      onClick={onClick}
    >
      {active === id && (
        <span
