...
const SideNavLink = ({ data, active, id, onClick }) => {
	return (
		<button
			className="w-full h-full md:h-auto block uppercase text-x text-[3.75vw] md:text-base xl:text-[1.1rem] font-medium text-[--grey] hover:font-medium hover:text-[--white] pointer-events-auto text-left  text-nowrap md:text-wrap"
			onClick={onClick}
		>
			{active === id && (
				<span
